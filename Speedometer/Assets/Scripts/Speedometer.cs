...
public class Speedometer : MonoBehaviour{
	...
	public LocationServiceHandler service;

	// -------------------------------------------------------------------

	public bool hasLocationAccess = false;
	...
	void Start(){
		...
		service = gameObject.GetComponent<LocationServiceHandler>();
		service.StartGPSLocationService();
	}

	/* Wait until services are ready */
	void Update()
	{
		CheckIfAccessToLocation();
	...
	private void FetchNewestData()
    {
		if (hasLocationAccess)
        {
			horizontalAccuracy = service.service.lastData.horizontalAccuracy;
			latitude = service.service.lastData.latitude;
			longitude = service.service.lastData.longitude;

			altitude = service.service.lastData.altitude;
			altitudeAccuracy = service.service.lastData.verticalAccuracy;
        }
	}

	private void CheckIfAccessToLocation()
	{
